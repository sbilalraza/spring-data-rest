...
public class MappingAwarePageableArgumentResolver implements HandlerMethodArgumentResolver, PageableArgumentResolver {
	 ...
	 */
	@Override
	public Pageable resolveArgument(MethodParameter methodParameter, NativeWebRequest webRequest) {

		Pageable pageable = delegate.resolveArgument(methodParameter, webRequest);
